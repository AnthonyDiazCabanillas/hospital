<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BusquedaDiagnostico.aspx.vb" Inherits="WebHCE.BusquedaDiagnostico" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="JSBDIV_TABLA" runat="server" id="divDiagnostico">  
            <asp:GridView ID="gvBusquedaDiagnostico" runat="server" AutoGenerateColumns="False" 
                    ShowHeaderWhenEmpty="true" CssClass="JSBTABLA-1" GridLines="None" 
                PageSize="5" PagerStyle-CssClass="JPAGINADO" >
                <Columns>
                    <asp:BoundField DataField="Codigo" HeaderText="CIE-10">
        ...
        <div class="JSBDIV_TABLA" runat="server" id="divDiagnosticoFavorito">  
            <asp:GridView ID="gvBusquedaDiagnosticoFavorito" runat="server" AutoGenerateColumns="False" 
                    ShowHeaderWhenEmpty="true" CssClass="JSBTABLA-1" GridLines="None" 
                PageSize="5" PagerStyle-CssClass="JPAGINADO" >
                <Columns>
                    <asp:BoundField DataField="cod_diagnostico" HeaderText="CIE-10">
                    <ItemStyle Width="20%" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="dsc_diagnostico" HeaderText="Diagnóstico" HtmlEncode="false" HtmlEncodeFormatString="true">
                        <ItemStyle Width="61%" HorizontalAlign="Left" />
                    </asp:BoundField>
                    <asp:BoundField DataField="ide_diagnosticofav" HeaderText="IdeDiagnosticoFav" HeaderStyle-CssClass="JCOL-OCULTA" > 
                        <HeaderStyle CssClass="JCOL-OCULTA"></HeaderStyle>
                        <ItemStyle  CssClass="JCOL-OCULTA IdeDiagnosticoFav" />
                    </asp:BoundField>
                    <asp:BoundField DataField="cod_diagnostico" HeaderText="cod_diagnostico" HeaderStyle-CssClass="JCOL-OCULTA" > 
                        <HeaderStyle CssClass="JCOL-OCULTA"></HeaderStyle>
                        <ItemStyle  CssClass="JCOL-OCULTA cod_diagnostico" />
                    </asp:BoundField>    
                    <asp:BoundField DataField="cod_diagnostico" HeaderText="cod_diagnostico" HeaderStyle-CssClass="JCOL-OCULTA" > 
                        <HeaderStyle CssClass="JCOL-OCULTA"></HeaderStyle>
                        <ItemStyle  CssClass="JCOL-OCULTA cod_diagnostico" />
