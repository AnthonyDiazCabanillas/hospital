<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BusquedaMedico.aspx.vb" Inherits="WebHCE.BusquedaMedico" %>
...
<body>
    <form id="frmBusquedaMedico" runat="server">
        <div class="JSBDIV_TABLA" runat="server">
            <asp:GridView ID="gvBusquedaMedico" runat="server" AutoGenerateColumns="False" 
                    ShowHeaderWhenEmpty="true" CssClass="JSBTABLA-1" GridLines="None" 
                PageSize="5" PagerStyle-CssClass="JPAGINADO" >
                <Columns>
                    <asp:BoundField DataField="Codigo" HeaderText="Cod. Med.">
                    <ItemStyle Width="20%" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Nombre" HeaderText="Médico" HtmlEncode="false" HtmlEncodeFormatString="true">
