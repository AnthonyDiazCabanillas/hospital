...
Public Class RpEvolucionClinica2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RpEvolucionClinica2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpEvolucionClinica2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpEvolucionClinica2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpEvolucionClinica2 = New RpEvolucionClinica2()
        rpt.Site = Me.Site
        Return rpt
    End Function
