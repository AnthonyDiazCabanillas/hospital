...
Public Class RpEvolucionClinica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpEvolucionClinica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpEvolucionClinica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpEvolucionClinica = New RpEvolucionClinica()
        rpt.Site = Me.Site
        Return rpt
    End Function
