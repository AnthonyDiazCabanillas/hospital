...
Public Class RpProcedimientosHM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpProcedimientosHM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpProcedimientosHM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpProcedimientosHM = New RpProcedimientosHM()
        rpt.Site = Me.Site
        Return rpt
    End Function
