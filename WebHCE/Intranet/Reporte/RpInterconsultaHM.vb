...
Public Class RpInterconsultaHM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpInterconsultaHM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpInterconsultaHM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpInterconsultaHM = New RpInterconsultaHM()
        rpt.Site = Me.Site
        Return rpt
    End Function
