...
Public Class RpMedicamentosa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpMedicamentosa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpMedicamentosa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpMedicamentosa = New RpMedicamentosa()
        rpt.Site = Me.Site
        Return rpt
    End Function
