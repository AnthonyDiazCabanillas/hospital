...
Public Class CIFormatoQuimio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.CIFormatoQuimio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCIFormatoQuimio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CIFormatoQuimio = New CIFormatoQuimio()
        rpt.Site = Me.Site
        Return rpt
    End Function
