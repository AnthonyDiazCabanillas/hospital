...
Public Class RpIndicacionMedicaV2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RpIndicacionMedicaV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpIndicacionMedicaV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpIndicacionMedicaV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpIndicacionMedicaV2 = New RpIndicacionMedicaV2()
        rpt.Site = Me.Site
        Return rpt
    End Function
