...
Public Class RpGestionClinica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpGestionClinica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpGestionClinica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpGestionClinica = New RpGestionClinica()
        rpt.Site = Me.Site
        Return rpt
    End Function
