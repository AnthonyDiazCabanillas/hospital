...
Public Class RpResumenExamenes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpResumenExamenes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpResumenExamenes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpResumenExamenes = New RpResumenExamenes()
        rpt.Site = Me.Site
        Return rpt
    End Function
