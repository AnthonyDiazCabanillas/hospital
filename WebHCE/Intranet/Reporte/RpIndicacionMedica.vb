...
Public Class RpIndicacionMedica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpIndicacionMedica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpIndicacionMedica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpIndicacionMedica = New RpIndicacionMedica()
        rpt.Site = Me.Site
        Return rpt
    End Function
