...
Public Class RpInterconsulta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebHCE.RpInterconsulta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpInterconsulta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RpInterconsulta = New RpInterconsulta()
        rpt.Site = Me.Site
        Return rpt
    End Function
