...
Public Class RegMedicoReconciliacionMedicamento
    ...
    Public Shared Function ValidaAlergiaPaciente(ByVal CodigoProducto As String) As String
        Dim pagina As New RegMedicoReconciliacionMedicamento()
    ...
    Public Function GuardarReconciliacionMedicamentosa_(ByVal CodigoProducto As String, ByVal NombreProducto As String, ByVal Dosis As String, _
        ...
        Try
            ...
            If NombreProducto = "" Or Dosis = "" Or Via = "" Or Frecuencia = "" Or CodigoAccion = "" Or FechaUltima = "" Or HoraUltima = "" Then 'IdeExamenFisicoCore = "" - JB - SE EXLUYE DE LA VALIDACION, YA NO ESTA EN EL FORMULARIO - 24/01/2020
            ...
            'INICIO - JB - COMENTADO, NO ESTA EN EL FORMATO RECIBIDO - 24/01/2020
            'oRceMedicamentosE.Campo = "ide_examenfisicores"
            'oRceMedicamentosE.ValorNuevo = IdeExamenFisicoCore.Trim().ToUpper()
            'oRceMedicamentosLN.Sp_RceMedicamentosaDet_Update(oRceMedicamentosE)
            'FIN - JB - COMENTADO, NO ESTA EN EL FORMATO RECIBIDO - 24/01/2020
